 ...
 * @author ESTUDIANTE
 */
public class Pregunta25 extends javax.swing.JFrame {
        double Diseño=0.0;
        double Sistemas=0.0;
        double Admin=0.0;
    ...
    public Pregunta25() {
       ...
       recidiseño.setText(Pregunta24.enviodiseño.getText());
       recisistemas.setText(Pregunta24.enviosistemas.getText());
       reciadmin.setText(Pregunta24.envioadmin.getText());
...
@Override
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fpreguntas/p25.jpg"))); // NOI18N
    ...
    private void NeextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NeextActionPerformed
        new Pregunta26().setVisible(true); //Abre siguiente ventana
    ...
    private void backActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backActionPerformed
        new Pregunta24().setVisible(true);
