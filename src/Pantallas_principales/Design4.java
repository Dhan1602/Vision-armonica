 ...
 * @author ESTUDIANTE
 */
public class Design4 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Fondos/Carreras/Diseño4.jpg"))); // NOI18N
    ...
    private void NeextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NeextActionPerformed
        new Designmore().setVisible(true); //Abre siguiente ventana
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Design4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
