...
public class Pregunta8 extends javax.swing.JFrame {
    ...
    public Pregunta8() {
       ...
       enviodiseño8.setText("0.0"); //Asignando 0 a diseño de esta ventana
       enviosistemas8.setText("0.0"); //Asignando 0 a sistemas de esta ventana
       envioadmin8.setText("0.0"); //Asignando 0 a admin de esta ventana
       recidiseño8.setText(Pregunta7.enviodiseño7.getText());
       recisistemas8.setText(Pregunta7.enviosistemas7.getText());
       reciadmin8.setText(Pregunta7.envioadmin7.getText());
       enviodiseño8.setVisible(false); //Ocultar valor diseño envio
       enviosistemas8.setVisible(false); //Ocultar valor sistemas envio
       envioadmin8.setVisible(false); //Ocultar valor admin envio
       recidiseño8.setVisible(false); //Ocultar valor diseño recibo
       recisistemas8.setVisible(false); //Ocultar valor sistemas recibo
       reciadmin8.setVisible(false); //Ocultar valor admin recibo
...
@Override
    ...
    private void initComponents() {
        ...
        recidiseño8 = new javax.swing.JTextField();
        recisistemas8 = new javax.swing.JTextField();
        reciadmin8 = new javax.swing.JTextField();
        enviodiseño8 = new javax.swing.JTextField();
        enviosistemas8 = new javax.swing.JTextField();
        envioadmin8 = new javax.swing.JTextField();
        ...
        recidiseño8.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                recidiseño8ActionPerformed(evt);
            }
        });
        jPanel1.add(recidiseño8, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 280, 50, -1));
        jPanel1.add(recisistemas8, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 310, 50, -1));
        jPanel1.add(reciadmin8, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 340, 50, -1));
        jPanel1.add(enviodiseño8, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 280, 50, -1));
        jPanel1.add(enviosistemas8, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 310, 50, -1));
        jPanel1.add(envioadmin8, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 340, 50, -1));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fpreguntas/p8.jpg"))); // NOI18N
    ...
    private void NeextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NeextActionPerformed
        new Pregunta9().setVisible(true); //Abre siguiente ventana
    ...
    private void SiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SiActionPerformed
        ...
        nextoff.setVisible(false); 
                if(condsis==0){ 
           if(conddiseño>0){ 
            Sistemas = Double.valueOf(recisistemas8.getText())+1; 
            String get=String.valueOf(Sistemas); 
            enviosistemas8.setText(get);
            Diseño = Double.valueOf(recidiseño8.getText()); 
            String get2=String.valueOf(Diseño); 
            enviodiseño8.setText(get2);
            Admin = Double.valueOf(reciadmin8.getText())+1; 
            String get3=String.valueOf(Admin); 
            envioadmin8.setText(get3);
            condsis=1;
            conddiseño=0;
            }
           else{
    ...
    private void UnpocoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UnpocoActionPerformed
        ...
        nextoff.setVisible(false);
                if(conddiseño==0){
           if(condsis>0){
            Sistemas = Double.valueOf(recisistemas8.getText())+0.5; 
            String get=String.valueOf(Sistemas); 
            enviosistemas8.setText(get);
            Diseño = Double.valueOf(recidiseño8.getText()); 
            String get2=String.valueOf(Diseño); 
            enviodiseño8.setText(get2);
            Admin = Double.valueOf(reciadmin8.getText())+0.5; 
            String get3=String.valueOf(Admin); 
            envioadmin8.setText(get3);            
            conddiseño=1;
            condsis=0;
    ...
    private void recidiseño8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_recidiseño8ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_recidiseño8ActionPerformed
    ...
    public static javax.swing.JTextField envioadmin8;
    public static javax.swing.JTextField enviodiseño8;
    public static javax.swing.JTextField enviosistemas8;
    ...
    public static javax.swing.JTextField reciadmin8;
    public static javax.swing.JTextField recidiseño8;
    public static javax.swing.JTextField recisistemas8;
