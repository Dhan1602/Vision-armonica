...
public class Pregunta9 extends javax.swing.JFrame {
    ...
    public Pregunta9() {
       ...
       enviodiseño9.setText("0.0"); //Asignando 0 a diseño de esta ventana
       enviosistemas9.setText("0.0"); //Asignando 0 a sistemas de esta ventana
       envioadmin9.setText("0.0"); //Asignando 0 a admin de esta ventana
       recidiseño9.setText(Pregunta8.enviodiseño8.getText());
       recisistemas9.setText(Pregunta8.enviosistemas8.getText());
       reciadmin9.setText(Pregunta8.envioadmin8.getText());
       enviodiseño9.setVisible(false); //Ocultar valor diseño envio
       enviosistemas9.setVisible(false); //Ocultar valor sistemas envio
       envioadmin9.setVisible(false); //Ocultar valor admin envio
       recidiseño9.setVisible(false); //Ocultar valor diseño recibo
       recisistemas9.setVisible(false); //Ocultar valor sistemas recibo
       reciadmin9.setVisible(false); //Ocultar valor admin recibo
...
@Override
    ...
    private void initComponents() {
        ...
        recidiseño9 = new javax.swing.JTextField();
        recisistemas9 = new javax.swing.JTextField();
        reciadmin9 = new javax.swing.JTextField();
        enviodiseño9 = new javax.swing.JTextField();
        enviosistemas9 = new javax.swing.JTextField();
        envioadmin9 = new javax.swing.JTextField();
        ...
        recidiseño9.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                recidiseño9ActionPerformed(evt);
            }
        });
        jPanel1.add(recidiseño9, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 280, 50, -1));
        jPanel1.add(recisistemas9, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 310, 50, -1));
        jPanel1.add(reciadmin9, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 340, 50, -1));
        jPanel1.add(enviodiseño9, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 280, 50, -1));
        jPanel1.add(enviosistemas9, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 310, 50, -1));
        jPanel1.add(envioadmin9, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 340, 50, -1));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fpreguntas/p9.jpg"))); // NOI18N
    ...
    private void NeextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NeextActionPerformed
        new Pregunta10().setVisible(true); //Abre siguiente ventana
    ...
    private void SiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SiActionPerformed
        ...
        nextoff.setVisible(false); 
                if(condsis==0){ 
           if(conddiseño>0){ 
            Sistemas = Double.valueOf(recisistemas9.getText())+1; 
            String get=String.valueOf(Sistemas); 
            enviosistemas9.setText(get);
            Diseño = Double.valueOf(recidiseño9.getText()); 
            String get2=String.valueOf(Diseño); 
            enviodiseño9.setText(get2);
            Admin = Double.valueOf(reciadmin9.getText())+1; 
            String get3=String.valueOf(Admin); 
            envioadmin9.setText(get3);
            condsis=1;
            conddiseño=0;
            }
           else{
    ...
    private void UnpocoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UnpocoActionPerformed
        ...
        nextoff.setVisible(false);
                if(conddiseño==0){
           if(condsis>0){
            Sistemas = Double.valueOf(recisistemas9.getText())+0.5; 
            String get=String.valueOf(Sistemas); 
            enviosistemas9.setText(get);
            Diseño = Double.valueOf(recidiseño9.getText()); 
            String get2=String.valueOf(Diseño); 
            enviodiseño9.setText(get2);
            Admin = Double.valueOf(reciadmin9.getText())+0.5; 
            String get3=String.valueOf(Admin); 
            envioadmin9.setText(get3);            
            conddiseño=1;
            condsis=0;
    ...
    private void recidiseño9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_recidiseño9ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_recidiseño9ActionPerformed
    ...
    public static javax.swing.JTextField envioadmin9;
    public static javax.swing.JTextField enviodiseño9;
    public static javax.swing.JTextField enviosistemas9;
    ...
    public static javax.swing.JTextField reciadmin9;
    public static javax.swing.JTextField recidiseño9;
    public static javax.swing.JTextField recisistemas9;
