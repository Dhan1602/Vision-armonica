 ...
 * @author ESTUDIANTE
 */
public class Pregunta56 extends javax.swing.JFrame {
        double Diseño=0.0;
        double Sistemas=0.0;
        double Admin=0.0;
    ...
    public Pregunta56() {
       ...
       recidiseño.setText(Pregunta55.enviodiseño.getText());
       recisistemas.setText(Pregunta55.enviosistemas.getText());
       reciadmin.setText(Pregunta55.envioadmin.getText());
...
@Override
    ...
    private void initComponents() {
        ...
        No.setText("Una aplicación móvil");
        ...
        Si.setText("Hacer posible que las máquinas aprendan de la experiencia");
        Si.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                SiActionPerformed(evt);
            }
        });
        jPanel1.add(Si, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 180, 550, 20));

        extra.setBackground(new java.awt.Color(255, 255, 255));
        Pregunta1.add(extra);
        extra.setFont(new java.awt.Font("NSimSun", 0, 18)); // NOI18N
        extra.setText("Ninguna de las anteriores");
        extra.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                extraActionPerformed(evt);
            }
        });
        jPanel1.add(extra, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 230, -1, -1));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fpreguntas/p56.jpg"))); // NOI18N
    ...
    if(Sistemas==Diseño&&Sistemas!=Admin){
        new ig1().setVisible(true);
        this.setVisible(false);       
    } else{ if(Sistemas==Admin&&Sistemas!=Diseño){
        new ig2().setVisible(true);
        this.setVisible(false);
        } else{ if(Diseño==Admin&&Diseño!=Sistemas){
                 new ig3().setVisible(true);
                 this.setVisible(false);
              } else{ if(Diseño==Admin&&Admin==Sistemas){
                         new ig4().setVisible(true);
                         this.setVisible(false);
                          } else{
                                 new nombre().setVisible(true);
                                 this.setVisible(false);
                                 nombre.recidiseño2.setText(enviodiseño.getText());
                                 nombre.recisistemas2.setText(enviosistemas.getText());
                                 nombre.reciadmin2.setText(envioadmin.getText());
                                }}}}
    ...
    private void SiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SiActionPerformed
        ...
        nextoff.setVisible(false); 
                if(condsis==0){ 
           if(conddiseño>0){ 
            Sistemas = Double.valueOf(recisistemas.getText())+1; 
            String get=String.valueOf(Sistemas); 
            enviosistemas.setText(get);
            Diseño = Double.valueOf(recidiseño.getText()); 
    ...
    private void backActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backActionPerformed
        new Pregunta55().setVisible(true);
        this.setVisible(false);
    ...
    public static javax.swing.JRadioButton extra;
