...
public class Pregunta5 extends javax.swing.JFrame {
    ...
    public Pregunta5() {
       ...
       enviodiseño5.setText("0.0"); //Asignando 0 a diseño de esta ventana
       enviosistemas5.setText("0.0"); //Asignando 0 a sistemas de esta ventana
       envioadmin5.setText("0.0"); //Asignando 0 a admin de esta ventana
       recidiseño5.setText(Pregunta4.enviodiseño4.getText());
       recisistemas5.setText(Pregunta4.enviosistemas4.getText());
       reciadmin5.setText(Pregunta4.envioadmin4.getText());
       enviodiseño5.setVisible(false); //Ocultar valor diseño envio
       enviosistemas5.setVisible(false); //Ocultar valor sistemas envio
       envioadmin5.setVisible(false); //Ocultar valor admin envio
       recidiseño5.setVisible(false); //Ocultar valor diseño recibo
       recisistemas5.setVisible(false); //Ocultar valor sistemas recibo
       reciadmin5.setVisible(false); //Ocultar valor admin recibo
...
@Override
    ...
    private void initComponents() {
        ...
        recidiseño5 = new javax.swing.JTextField();
        recisistemas5 = new javax.swing.JTextField();
        reciadmin5 = new javax.swing.JTextField();
        enviodiseño5 = new javax.swing.JTextField();
        enviosistemas5 = new javax.swing.JTextField();
        envioadmin5 = new javax.swing.JTextField();
        ...
        recidiseño5.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                recidiseño5ActionPerformed(evt);
            }
        });
        jPanel1.add(recidiseño5, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 280, 50, -1));
        jPanel1.add(recisistemas5, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 310, 50, -1));
        jPanel1.add(reciadmin5, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 340, 50, -1));
        jPanel1.add(enviodiseño5, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 280, 50, -1));
        jPanel1.add(enviosistemas5, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 310, 50, -1));
        jPanel1.add(envioadmin5, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 340, 50, -1));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fpreguntas/p5.jpg"))); // NOI18N
    ...
    private void NeextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NeextActionPerformed
        new Pregunta6().setVisible(true); //Abre siguiente ventana
    ...
    private void SiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SiActionPerformed
        ...
        nextoff.setVisible(false); 
                if(condsis==0){ 
           if(conddiseño>0){ 
            Sistemas = Double.valueOf(recisistemas5.getText()); 
            String get=String.valueOf(Sistemas); 
            enviosistemas5.setText(get);
            Diseño = Double.valueOf(recidiseño5.getText())+1; 
            String get2=String.valueOf(Diseño); 
            enviodiseño5.setText(get2);
            Admin = Double.valueOf(reciadmin5.getText()); 
            String get3=String.valueOf(Admin); 
            envioadmin5.setText(get3);
            condsis=1;
            conddiseño=0;
            }
           else{
    ...
    private void UnpocoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UnpocoActionPerformed
        ...
        nextoff.setVisible(false);
           ...
           if(condsis>0){
            ...
            String get=String.valueOf(Sistemas); 
            enviosistemas5.setText(get);
            Diseño = Double.valueOf(recidiseño5.getText())+0.5; 
            String get2=String.valueOf(Diseño); 
            enviodiseño5.setText(get2);
            Admin = Double.valueOf(reciadmin5.getText()); 
            String get3=String.valueOf(Admin); 
    ...
    private void recidiseño5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_recidiseño5ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_recidiseño5ActionPerformed
    ...
    public static javax.swing.JTextField envioadmin5;
    public static javax.swing.JTextField enviodiseño5;
    public static javax.swing.JTextField enviosistemas5;
    ...
    public static javax.swing.JTextField reciadmin5;
    public static javax.swing.JTextField recidiseño5;
    public static javax.swing.JTextField recisistemas5;
