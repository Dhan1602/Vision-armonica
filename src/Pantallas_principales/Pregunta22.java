 ...
 * @author ESTUDIANTE
 */
public class Pregunta22 extends javax.swing.JFrame {
        double Diseño=0.0;
        double Sistemas=0.0;
        double Admin=0.0;
    ...
    public Pregunta22() {
       ...
       recidiseño.setText(Pregunta21.enviodiseño.getText());
       recisistemas.setText(Pregunta21.enviosistemas.getText());
       reciadmin.setText(Pregunta21.envioadmin.getText());
...
@Override
    ...
    private void initComponents() {
        ...
        No.setText("No, actúo al instante");
        ...
        Unpoco.setText("Solo cuando lo amerita");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fpreguntas/p22.jpg"))); // NOI18N
    ...
    private void NeextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NeextActionPerformed
        new Pregunta23().setVisible(true); //Abre siguiente ventana
    ...
    private void backActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backActionPerformed
        new Pregunta21().setVisible(true);
