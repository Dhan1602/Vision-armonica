...
public class Pregunta4 extends javax.swing.JFrame {
    ...
    public Pregunta4() {
       ...
       enviodiseño4.setText("0.0"); //Asignando 0 a diseño de esta ventana
       enviosistemas4.setText("0.0"); //Asignando 0 a sistemas de esta ventana
       envioadmin4.setText("0.0"); //Asignando 0 a admin de esta ventana
       recidiseño4.setText(Pregunta3.enviodiseño3.getText());
       recisistemas4.setText(Pregunta3.enviosistemas3.getText());
       reciadmin4.setText(Pregunta3.envioadmin3.getText());
       enviodiseño4.setVisible(false); //Ocultar valor diseño envio
       enviosistemas4.setVisible(false); //Ocultar valor sistemas envio
       envioadmin4.setVisible(false); //Ocultar valor admin envio
       recidiseño4.setVisible(false); //Ocultar valor diseño recibo
       recisistemas4.setVisible(false); //Ocultar valor sistemas recibo
       reciadmin4.setVisible(false); //Ocultar valor admin recibo
...
@Override
    ...
    private void initComponents() {
        ...
        recidiseño4 = new javax.swing.JTextField();
        recisistemas4 = new javax.swing.JTextField();
        reciadmin4 = new javax.swing.JTextField();
        enviodiseño4 = new javax.swing.JTextField();
        enviosistemas4 = new javax.swing.JTextField();
        envioadmin4 = new javax.swing.JTextField();
        ...
        recidiseño4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                recidiseño4ActionPerformed(evt);
            }
        });
        jPanel1.add(recidiseño4, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 280, 50, -1));
        jPanel1.add(recisistemas4, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 310, 50, -1));
        jPanel1.add(reciadmin4, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 340, 50, -1));
        jPanel1.add(enviodiseño4, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 280, 50, -1));
        jPanel1.add(enviosistemas4, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 310, 50, -1));
        jPanel1.add(envioadmin4, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 340, 50, -1));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fpreguntas/p4.jpg"))); // NOI18N
    ...
    private void NeextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NeextActionPerformed
        new Pregunta5().setVisible(true); //Abre siguiente ventana
    ...
    private void SiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SiActionPerformed
        ...
        nextoff.setVisible(false); 
                if(condsis==0){ 
           if(conddiseño>0){ 
            Sistemas = Double.valueOf(recisistemas4.getText()); 
            String get=String.valueOf(Sistemas); 
            enviosistemas4.setText(get);
            Diseño = Double.valueOf(recidiseño4.getText()); 
            String get2=String.valueOf(Diseño); 
            enviodiseño4.setText(get2);
            Admin = Double.valueOf(reciadmin4.getText())+1; 
            String get3=String.valueOf(Admin); 
            envioadmin4.setText(get3);
            condsis=1;
            conddiseño=0;
            }
           else{
    ...
    private void UnpocoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UnpocoActionPerformed
        ...
        nextoff.setVisible(false);
           ...
           if(condsis>0){
            ...
            String get2=String.valueOf(Diseño); 
            enviodiseño4.setText(get2);
            Admin = Double.valueOf(reciadmin4.getText())+0.5; 
            String get3=String.valueOf(Admin); 
            envioadmin4.setText(get3);            
            conddiseño=1;
            condsis=0;
    ...
    private void recidiseño4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_recidiseño4ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_recidiseño4ActionPerformed
    ...
    public static javax.swing.JTextField envioadmin4;
    public static javax.swing.JTextField enviodiseño4;
    public static javax.swing.JTextField enviosistemas4;
    ...
    public static javax.swing.JTextField reciadmin4;
    public static javax.swing.JTextField recidiseño4;
    public static javax.swing.JTextField recisistemas4;
