 ...
 * @author ESTUDIANTE
 */
public class Pregunta54 extends javax.swing.JFrame {
        double Diseño=0.0;
        double Sistemas=0.0;
        double Admin=0.0;
    ...
    public Pregunta54() {
       ...
       recidiseño.setText(Pregunta53.enviodiseño.getText());
       recisistemas.setText(Pregunta53.enviosistemas.getText());
       reciadmin.setText(Pregunta53.envioadmin.getText());
...
@Override
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fpreguntas/p54.jpg"))); // NOI18N
    ...
    private void NeextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NeextActionPerformed
        new Pregunta55().setVisible(true); //Abre siguiente ventana
    ...
    private void backActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backActionPerformed
        new Pregunta53().setVisible(true);
