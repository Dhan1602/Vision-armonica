...
public class Pregunta2 extends javax.swing.JFrame {
        ...
        double Sistemas=0.0;
        double Admin=0.0;
        int conddiseño; //Verificador si se presiona o no este botón
        int condsis;
        int condadm;
        String get; //Conversor de double a string
        String get2;
        String get3;
    /**
    ...
    public Pregunta2() {
       ...
       enviodiseño.setText("0.0");
       enviosistemas.setText("0.0");
       envioadmin.setText("0.0");
       recidiseño2.setText(Pregunta1.enviodiseño.getText());
       recisistemas2.setText(Pregunta1.enviosistemas.getText());
       reciadmin2.setText(Pregunta1.envioadmin.getText());
       enviodiseño.setVisible(false);
       enviosistemas.setVisible(false);
       envioadmin.setVisible(false);
       recidiseño2.setVisible(false);
       recisistemas2.setVisible(false);
       reciadmin2.setVisible(false);
    }
@Override
    ...
    private void initComponents() {
        ...
        recidiseño2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                recidiseño2ActionPerformed(evt);
            }
        });
        jPanel1.add(recidiseño2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 280, 50, -1));
        jPanel1.add(recisistemas2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 310, 50, -1));
        jPanel1.add(reciadmin2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 340, 50, -1));

        enviodiseño.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                enviodiseñoActionPerformed(evt);
            }
        });
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fpreguntas/p2.jpg"))); // NOI18N
    ...
    private void NeextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NeextActionPerformed
        ...
        //Pregunta3.recidiseño3.setText(enviodiseño.getText()); //Manda datos a la siguiente pagina
        //Pregunta3.recisistemas3.setText(enviosistemas.getText());
        //Pregunta3.reciadmin3.setText(envioadmin.getText());
    ...
    private void SiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SiActionPerformed
        ...
        nextoff.setVisible(false);
                if(condsis==0){
           if(conddiseño>0){
            Sistemas = Double.valueOf(recisistemas2.getText())+1;
            String get=String.valueOf(Sistemas);
            enviosistemas.setText(get);
            String get2=String.valueOf(recidiseño2.getText());
           ...
           if(condadm>0){
            ...
            String get=String.valueOf(Sistemas);
            enviosistemas.setText(get);
            String get2=String.valueOf(reciadmin2.getText());
            envioadmin.setText(get2);
            condsis=1;
            condadm=0;
             }
           else{
        ...
        String get2=String.valueOf(reciadmin2.getText());
        envioadmin.setText(get2);
        String get3=String.valueOf(recidiseño2.getText());
        enviodiseño.setText(get3);
        condsis=1;
        }
           }
    ...
    private void UnpocoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UnpocoActionPerformed
        ...
        nextoff.setVisible(false);
                if(conddiseño==0){
           if(condsis>0){
            Sistemas = Double.valueOf(recisistemas2.getText())+0.5;
            String get=String.valueOf(recidiseño2.getText());
            enviodiseño.setText(get);
            String get2=String.valueOf(Sistemas);
            enviosistemas.setText(get2);
            String get3=String.valueOf(reciadmin2.getText());
    ...
    private void NoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NoActionPerformed
        ...
        nextoff.setVisible(false);
           ...
           if(condsis>0){
            Sistemas = Double.valueOf(recisistemas2.getText())-1;
            String get=String.valueOf(reciadmin2.getText());
            envioadmin.setText(get);
            String get2=String.valueOf(Sistemas);
            enviosistemas.setText(get2);
            String get3=String.valueOf(recidiseño2.getText());
            enviodiseño.setText(get3);
    ...
    private void recidiseño2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_recidiseño2ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_recidiseño2ActionPerformed

    private void enviodiseñoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enviodiseñoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_enviodiseñoActionPerformed
