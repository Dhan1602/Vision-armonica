 ...
 * @author ESTUDIANTE
 */
public class Sistemas2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Fondos/Carreras/Sistemas2.jpg"))); // NOI18N
    ...
    private void NeextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NeextActionPerformed
        new Sistemas3().setVisible(true); //Abre siguiente ventana
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sistemas2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
