 ...
 * @author ESTUDIANTE
 */
public class Pregunta29 extends javax.swing.JFrame {
        double Diseño=0.0;
        double Sistemas=0.0;
        double Admin=0.0;
    ...
    public Pregunta29() {
       ...
       recidiseño.setText(Pregunta28.enviodiseño.getText());
       recisistemas.setText(Pregunta28.enviosistemas.getText());
       reciadmin.setText(Pregunta28.envioadmin.getText());
...
@Override
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fpreguntas/p29.jpg"))); // NOI18N
    ...
    private void NeextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NeextActionPerformed
        new Pregunta30().setVisible(true); //Abre siguiente ventana
