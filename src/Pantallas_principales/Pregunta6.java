...
public class Pregunta6 extends javax.swing.JFrame {
    ...
    public Pregunta6() {
       ...
       enviodiseño6.setText("0.0"); //Asignando 0 a diseño de esta ventana
       enviosistemas6.setText("0.0"); //Asignando 0 a sistemas de esta ventana
       envioadmin6.setText("0.0"); //Asignando 0 a admin de esta ventana
       recidiseño6.setText(Pregunta5.enviodiseño5.getText());
       recisistemas6.setText(Pregunta5.enviosistemas5.getText());
       reciadmin6.setText(Pregunta5.envioadmin5.getText());
       enviodiseño6.setVisible(false); //Ocultar valor diseño envio
       enviosistemas6.setVisible(false); //Ocultar valor sistemas envio
       envioadmin6.setVisible(false); //Ocultar valor admin envio
       recidiseño6.setVisible(false); //Ocultar valor diseño recibo
       recisistemas6.setVisible(false); //Ocultar valor sistemas recibo
       reciadmin6.setVisible(false); //Ocultar valor admin recibo
...
@Override
    ...
    private void initComponents() {
        ...
        recidiseño6 = new javax.swing.JTextField();
        recisistemas6 = new javax.swing.JTextField();
        reciadmin6 = new javax.swing.JTextField();
        enviodiseño6 = new javax.swing.JTextField();
        enviosistemas6 = new javax.swing.JTextField();
        envioadmin6 = new javax.swing.JTextField();
        ...
        recidiseño6.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                recidiseño6ActionPerformed(evt);
            }
        });
        jPanel1.add(recidiseño6, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 280, 50, -1));
        jPanel1.add(recisistemas6, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 310, 50, -1));
        jPanel1.add(reciadmin6, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 340, 50, -1));
        jPanel1.add(enviodiseño6, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 280, 50, -1));
        jPanel1.add(enviosistemas6, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 310, 50, -1));
        jPanel1.add(envioadmin6, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 340, 50, -1));
        ...
        No.setText("Si, es un componente clave de la medicina china.");
        ...
        Si.setText("Si, una técnica artística que consiste en hacer una obra mediante el uso de diminutos puntos");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fpreguntas/p6.jpg"))); // NOI18N
    ...
    private void NeextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NeextActionPerformed
        new Pregunta7().setVisible(true); //Abre siguiente ventana
    ...
    private void SiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SiActionPerformed
        ...
        nextoff.setVisible(false); 
                if(condsis==0){ 
           if(conddiseño>0){ 
            Sistemas = Double.valueOf(recisistemas6.getText()); 
            String get=String.valueOf(Sistemas); 
            enviosistemas6.setText(get);
            Diseño = Double.valueOf(recidiseño6.getText())+1; 
            String get2=String.valueOf(Diseño); 
            enviodiseño6.setText(get2);
            Admin = Double.valueOf(reciadmin6.getText()); 
            String get3=String.valueOf(Admin); 
            envioadmin6.setText(get3);
            condsis=1;
            conddiseño=0;
            }
           else{
    ...
    private void NoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NoActionPerformed
        ...
        nextoff.setVisible(false);
           ...
           if(condsis>0){
            ...
            String get=String.valueOf(Sistemas); 
            enviosistemas6.setText(get);
            Diseño = Double.valueOf(recidiseño6.getText())+0.5; 
            String get2=String.valueOf(Diseño); 
            enviodiseño6.setText(get2);
            Admin = Double.valueOf(reciadmin6.getText()); 
            String get3=String.valueOf(Admin); 
    ...
    private void recidiseño6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_recidiseño6ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_recidiseño6ActionPerformed
    ...
    public static javax.swing.JTextField envioadmin6;
    public static javax.swing.JTextField enviodiseño6;
    public static javax.swing.JTextField enviosistemas6;
    ...
    public static javax.swing.JTextField reciadmin6;
    public static javax.swing.JTextField recidiseño6;
    public static javax.swing.JTextField recisistemas6;
