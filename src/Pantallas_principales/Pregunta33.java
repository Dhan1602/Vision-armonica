 ...
 * @author ESTUDIANTE
 */
public class Pregunta33 extends javax.swing.JFrame {
        double Diseño=0.0;
        double Sistemas=0.0;
        double Admin=0.0;
    ...
    public Pregunta33() {
       ...
       recidiseño.setText(Pregunta32.enviodiseño.getText());
       recisistemas.setText(Pregunta32.enviosistemas.getText());
       reciadmin.setText(Pregunta32.envioadmin.getText());
...
@Override
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fpreguntas/p33.jpg"))); // NOI18N
    ...
    private void NeextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NeextActionPerformed
        new Pregunta34().setVisible(true); //Abre siguiente ventana
    ...
    private void backActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backActionPerformed
        new Pregunta32().setVisible(true);
