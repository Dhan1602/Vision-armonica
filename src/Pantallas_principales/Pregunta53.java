 ...
 * @author ESTUDIANTE
 */
public class Pregunta53 extends javax.swing.JFrame {
        double Diseño=0.0;
        double Sistemas=0.0;
        double Admin=0.0;
    ...
    public Pregunta53() {
       ...
       recidiseño.setText(Pregunta52.enviodiseño.getText());
       recisistemas.setText(Pregunta52.enviosistemas.getText());
       reciadmin.setText(Pregunta52.envioadmin.getText());
...
@Override
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fpreguntas/p53.jpg"))); // NOI18N
    ...
    private void NeextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NeextActionPerformed
        new Pregunta54().setVisible(true); //Abre siguiente ventana
    ...
    private void backActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backActionPerformed
        new Pregunta52().setVisible(true);
