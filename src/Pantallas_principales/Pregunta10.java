...
public class Pregunta10 extends javax.swing.JFrame {
    ...
    public Pregunta10() {
       ...
       enviodiseño10.setText("0.0"); //Asignando 0 a diseño de esta ventana
       enviosistemas10.setText("0.0"); //Asignando 0 a sistemas de esta ventana
       envioadmin10.setText("0.0"); //Asignando 0 a admin de esta ventana
       recidiseño10.setText(Pregunta9.enviodiseño9.getText());
       recisistemas10.setText(Pregunta9.enviosistemas9.getText());
       reciadmin10.setText(Pregunta9.envioadmin9.getText());
       enviodiseño10.setVisible(false); //Ocultar valor diseño envio
       enviosistemas10.setVisible(false); //Ocultar valor sistemas envio
       envioadmin10.setVisible(false); //Ocultar valor admin envio
       recidiseño10.setVisible(false); //Ocultar valor diseño recibo
       recisistemas10.setVisible(false); //Ocultar valor sistemas recibo
       reciadmin10.setVisible(false); //Ocultar valor admin recibo
...
@Override
    ...
    private void initComponents() {
        ...
        recidiseño10 = new javax.swing.JTextField();
        recisistemas10 = new javax.swing.JTextField();
        reciadmin10 = new javax.swing.JTextField();
        enviodiseño10 = new javax.swing.JTextField();
        enviosistemas10 = new javax.swing.JTextField();
        envioadmin10 = new javax.swing.JTextField();
        ...
        recidiseño10.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                recidiseño10ActionPerformed(evt);
            }
        });
        jPanel1.add(recidiseño10, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 280, 50, -1));
        jPanel1.add(recisistemas10, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 310, 50, -1));
        jPanel1.add(reciadmin10, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 340, 50, -1));
        jPanel1.add(enviodiseño10, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 280, 50, -1));
        jPanel1.add(enviosistemas10, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 310, 50, -1));
        jPanel1.add(envioadmin10, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 340, 50, -1));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fpreguntas/p10.jpg"))); // NOI18N
    ...
    private void NeextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NeextActionPerformed
        new Pregunta11().setVisible(true); //Abre siguiente ventana
    ...
    private void SiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SiActionPerformed
        ...
        nextoff.setVisible(false); 
                if(condsis==0){ 
           if(conddiseño>0){ 
            Sistemas = Double.valueOf(recisistemas10.getText()); 
            String get=String.valueOf(Sistemas); 
            enviosistemas10.setText(get);
            Diseño = Double.valueOf(recidiseño10.getText()); 
            String get2=String.valueOf(Diseño); 
            enviodiseño10.setText(get2);
            Admin = Double.valueOf(reciadmin10.getText())+1; 
            String get3=String.valueOf(Admin); 
            envioadmin10.setText(get3);
            condsis=1;
            conddiseño=0;
            }
           else{
    ...
    private void UnpocoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UnpocoActionPerformed
        ...
        nextoff.setVisible(false);
           ...
           if(condsis>0){
            ...
            String get2=String.valueOf(Diseño); 
            enviodiseño10.setText(get2);
            Admin = Double.valueOf(reciadmin10.getText())+0.5; 
            String get3=String.valueOf(Admin); 
            envioadmin10.setText(get3);            
            conddiseño=1;
            condsis=0;
    ...
    private void recidiseño10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_recidiseño10ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_recidiseño10ActionPerformed
    ...
    public static javax.swing.JTextField envioadmin10;
    public static javax.swing.JTextField enviodiseño10;
    public static javax.swing.JTextField enviosistemas10;
    ...
    public static javax.swing.JTextField reciadmin10;
    public static javax.swing.JTextField recidiseño10;
    public static javax.swing.JTextField recisistemas10;
