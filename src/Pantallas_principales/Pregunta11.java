...
public class Pregunta11 extends javax.swing.JFrame {
    ...
    public Pregunta11() {
       ...
       enviodiseño11.setText("0.0"); //Asignando 0 a diseño de esta ventana
       enviosistemas11.setText("0.0"); //Asignando 0 a sistemas de esta ventana
       envioadmin11.setText("0.0"); //Asignando 0 a admin de esta ventana
       recidiseño11.setText(Pregunta10.enviodiseño10.getText());
       recisistemas11.setText(Pregunta10.enviosistemas10.getText());
       reciadmin11.setText(Pregunta10.envioadmin10.getText());
       enviodiseño11.setVisible(false); //Ocultar valor diseño envio
       enviosistemas11.setVisible(false); //Ocultar valor sistemas envio
       envioadmin11.setVisible(false); //Ocultar valor admin envio
       recidiseño11.setVisible(false); //Ocultar valor diseño recibo
       recisistemas11.setVisible(false); //Ocultar valor sistemas recibo
       reciadmin11.setVisible(false); //Ocultar valor admin recibo
...
@Override
    ...
    private void initComponents() {
        ...
        recidiseño11 = new javax.swing.JTextField();
        recisistemas11 = new javax.swing.JTextField();
        reciadmin11 = new javax.swing.JTextField();
        enviodiseño11 = new javax.swing.JTextField();
        enviosistemas11 = new javax.swing.JTextField();
        envioadmin11 = new javax.swing.JTextField();
        ...
        recidiseño11.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                recidiseño11ActionPerformed(evt);
            }
        });
        jPanel1.add(recidiseño11, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 280, 50, -1));
        jPanel1.add(recisistemas11, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 310, 50, -1));
        jPanel1.add(reciadmin11, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 340, 50, -1));
        jPanel1.add(enviodiseño11, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 280, 50, -1));
        jPanel1.add(enviosistemas11, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 310, 50, -1));
        jPanel1.add(envioadmin11, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 340, 50, -1));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fpreguntas/p11.jpg"))); // NOI18N
    ...
    private void NeextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NeextActionPerformed
        new Pregunta12().setVisible(true); //Abre siguiente ventana
    ...
    private void SiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SiActionPerformed
        ...
        nextoff.setVisible(false); 
                if(condsis==0){ 
           if(conddiseño>0){ 
            Sistemas = Double.valueOf(recisistemas11.getText())+1; 
            String get=String.valueOf(Sistemas); 
            enviosistemas11.setText(get);
            Diseño = Double.valueOf(recidiseño11.getText())+1; 
            String get2=String.valueOf(Diseño); 
            enviodiseño11.setText(get2);
            Admin = Double.valueOf(reciadmin11.getText()); 
            String get3=String.valueOf(Admin); 
            envioadmin11.setText(get3);
            condsis=1;
            conddiseño=0;
            }
           else{
    ...
    private void UnpocoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UnpocoActionPerformed
        ...
        nextoff.setVisible(false);
                if(conddiseño==0){
           if(condsis>0){
            Sistemas = Double.valueOf(recisistemas11.getText())+0.5; 
            String get=String.valueOf(Sistemas); 
            enviosistemas11.setText(get);
            Diseño = Double.valueOf(recidiseño11.getText())+0.5; 
            String get2=String.valueOf(Diseño); 
            enviodiseño11.setText(get2);
            Admin = Double.valueOf(reciadmin11.getText()); 
            String get3=String.valueOf(Admin); 
    ...
    private void recidiseño11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_recidiseño11ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_recidiseño11ActionPerformed
    ...
    public static javax.swing.JTextField envioadmin11;
    public static javax.swing.JTextField enviodiseño11;
    public static javax.swing.JTextField enviosistemas11;
    ...
    public static javax.swing.JTextField reciadmin11;
    public static javax.swing.JTextField recidiseño11;
    public static javax.swing.JTextField recisistemas11;
