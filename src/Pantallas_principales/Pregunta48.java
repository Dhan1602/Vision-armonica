 ...
 * @author ESTUDIANTE
 */
public class Pregunta48 extends javax.swing.JFrame {
        double Diseño=0.0;
        double Sistemas=0.0;
        double Admin=0.0;
    ...
    public Pregunta48() {
       ...
       recidiseño.setText(Pregunta47.enviodiseño.getText());
       recisistemas.setText(Pregunta47.enviosistemas.getText());
       reciadmin.setText(Pregunta47.envioadmin.getText());
...
@Override
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/fpreguntas/p48.jpg"))); // NOI18N
    ...
    private void NeextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NeextActionPerformed
        new Pregunta49().setVisible(true); //Abre siguiente ventana
    ...
    private void NoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NoActionPerformed
        ...
        nextoff.setVisible(false);
                if(condadm==0){
           if(condsis>0){
            Sistemas = Double.valueOf(recisistemas.getText())+0.5; 
            String get=String.valueOf(Sistemas); 
            enviosistemas.setText(get);
            Diseño = Double.valueOf(recidiseño.getText()); 
            String get2=String.valueOf(Diseño); 
    ...
    private void backActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backActionPerformed
        new Pregunta47().setVisible(true);
